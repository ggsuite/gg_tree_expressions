...
void main() {
  group('gg_tree_expressions_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_tree_expressions_version.dart');
